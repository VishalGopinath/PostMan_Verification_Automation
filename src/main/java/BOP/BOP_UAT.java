...
public class BOP_UAT {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream inputStream = BOP_UAT.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (inputStream == null) {
    ...
    private static boolean processRequest(Path jsonFilePath, Properties properties, LocalDate today) throws IOException {
        ...
        String token = properties.getProperty("UAT_Token").trim();
        ...
        String apiUrl = "https://isopmtbopkb.uat.solartis.net/KnowledgeEngineV6_10/KnowledgeBase/FireEventV3";
        try {
