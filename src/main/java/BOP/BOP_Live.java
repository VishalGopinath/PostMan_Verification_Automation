...
public class BOP_Live {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream inputStream = BOP_Live.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (inputStream == null) {
    ...
    private static boolean processRequest(Path jsonFilePath, Properties properties, LocalDate today) throws IOException {
        ...
        String token = properties.getProperty("Live_Token").trim();
        ...
        String apiUrl = "https://parserbopkb.solartis.net/KnowledgeEngineV6_9/KnowledgeBase/FireEventV3";
        try {
